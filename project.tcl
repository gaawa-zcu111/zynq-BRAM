...
#
# Generated by Vivado on Wed May 22 15:05:42 +0200 2024
...
#
#    "C:/git-zcu111/zqnq_bram/ip/zynq_bram_gpio/hdl/zynq_bram_gpio_wrapper.vhd"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/ip/zynq_bram_gpio/hdl/zynq_bram_gpio_wrapper.vhd"]"\
  ]
  foreach ifile $files {
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../Users/nicol/vivado/rdf0476-zcu111-rf-dc-eval-tool-2021-1/pl/MTSDesign_8x8/board_files"]" -objects $obj
...
set file "$origin_dir/ip/zynq_bram_gpio/hdl/zynq_bram_gpio_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "zynq_bram_gpio_wrapper" -objects $obj
...
# Proc to create BD zynq_bram_gpio
proc cr_bd_zynq_bram_gpio { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name zynq_bram_gpio
  ...
  set dip_switches_8bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 -portmaps { \
   TRI_I { physical_name dip_switches_8bits_tri_i direction I left 7 right 0 } \
   } \
  dip_switches_8bits ]
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports dip_switches_8bits]

  set led_8bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 -portmaps { \
   TRI_O { physical_name led_8bits_tri_o direction O left 7 right 0 } \
   } \
  led_8bits ]
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports led_8bits]

  set push_buttons_5bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 -portmaps { \
   TRI_I { physical_name push_buttons_5bits_tri_i direction I left 4 right 0 } \
   } \
  push_buttons_5bits ]
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports push_buttons_5bits]
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1}\
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins buttons/S_AXI]
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins leds/S_AXI]
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins axi_smc/M03_AXI] [get_bd_intf_pins switches/S_AXI]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins buttons/s_axi_aresetn] [get_bd_pins leds/s_axi_aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins switches/s_axi_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins buttons/s_axi_aclk] [get_bd_pins leds/s_axi_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins switches/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00400000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0400000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs buttons/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0410000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs leds/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0420000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs switches/S_AXI/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.71697",
   "Default View_TopLeft":"0,-61",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port dip_switches_8bits -pg 1 -lvl 5 -x 1530 -y 500 -defaultsOSRD
preplace port led_8bits -pg 1 -lvl 5 -x 1530 -y 360 -defaultsOSRD
preplace port push_buttons_5bits -pg 1 -lvl 5 -x 1530 -y 220 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 3 -x 1100 -y 80 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 4 -x 1380 -y 80 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 790 -y 210 -defaultsOSRD
preplace inst buttons -pg 1 -lvl 3 -x 1100 -y 220 -defaultsOSRD
preplace inst leds -pg 1 -lvl 3 -x 1100 -y 360 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 330 -y 410 -defaultsOSRD
preplace inst switches -pg 1 -lvl 3 -x 1100 -y 500 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 220 -defaultsOSRD
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 2 650 120 960
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 120 640 110 950
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 130 630
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 N 70
preplace netloc axi_bram_ctrl_0_BRAM_PORTB 1 3 1 N 90
preplace netloc axi_smc_M00_AXI 1 2 1 930 60n
preplace netloc axi_smc_M01_AXI 1 2 1 N 200
preplace netloc axi_smc_M02_AXI 1 2 1 940 220n
preplace netloc axi_smc_M03_AXI 1 2 1 930 240n
preplace netloc buttons_GPIO 1 3 2 NJ 220 NJ
preplace netloc leds_GPIO 1 3 2 NJ 360 NJ
preplace netloc switches_GPIO 1 3 2 NJ 500 NJ
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N 190
levelinfo -pg 1 0 330 790 1100 1380 1530
pagesize -pg 1 -db -bbox -sgen 0 0 1710 580
"
}
...
# End of cr_bd_zynq_bram_gpio()
cr_bd_zynq_bram_gpio ""
set_property REGISTERED_WITH_MANAGER "1" [get_files zynq_bram_gpio.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zynq_bram_gpio.bd ] 
